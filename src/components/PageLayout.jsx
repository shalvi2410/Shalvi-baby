...
const PageLayout = ({ children }) => {
  ...
  const socialMedias = [
    {
      link: "https://www.instagram.com/shall.we__/",
      text: "INSTAGRAM",
    },
    {
      link: "https://twitter.com/shalvi_rajput07",
      text: "TWITTER",
    },
    {
    ...
    {
      link: "mailto:singhshalvi1009@gmail.com",
      text: "EMAIL",
    },
    // {
    //   link: "https://bgirlzoee-3d.netlify.app/",
    //   text: "YOUR GIFT",
    // },
  ];
    ...
    <>
      ...
      <footer className="Footer | py-5">
        <div className="container text-center">
          ...
          <div className="mb-4">
            <a
              href="https://www.instagram.com/shall.wee__/"
              target="_blank"
              rel="noopener noreferrer"
