...
const InterestsSection = () => {
  ...
  const [showInterest5, setShowInterest5] = useState(false);
  const [showInterest6, setShowInterest6] = useState(false);
  ...
  function handleAnimateInterests(isVisible, interestType) {
    ...
    } else if (interestType === 5) {
      setShowInterest5(isVisible);
    } else if (interestType === 6) {
      setShowInterest6(isVisible);
    }
  }
      ...
      <div className="container my-sm-5 mb-5">
        ...
        <div className="row all-center" data-aos="fade-up">
          {interests.map((interest) => (
            <div
              className="InterestCard | col-lg-4 all-center text-center position-relative overflow-hidden"
              key={interest.type}
            >
